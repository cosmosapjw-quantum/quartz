...
from quartz.selfplay_runtime import is_chess_game, is_go_game, rust_game_name as _rust_game_name_impl
...
def _make_go_cfg(board, filters, blocks, vh, iters, games, temp_th, dir_a, steps, batch, min_visits, check_interval, recent_window, suffix="cn"):
    cfg = dict(
