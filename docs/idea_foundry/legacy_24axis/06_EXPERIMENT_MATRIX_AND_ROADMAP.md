...
```text
quartz/idea_foundry/legacy_24axis/trace_adapter.py
...
```text
quartz/idea_foundry/legacy_24axis/stop_council.py
...
```text
quartz/idea_foundry/legacy_24axis/static_anchor_rpo.py
quartz/idea_foundry/legacy_24axis/residual_mass.py
