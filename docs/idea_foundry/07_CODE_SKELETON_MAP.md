...
파일: `quartz/idea_foundry/contracts.py`
...
파일: `src/mcts/policy/foundry_contracts.rs`
...
파일: `src/mcts/policy/foundry_axes.rs`
...
권장 신규 파일: `quartz/idea_foundry/trace_adapter.py`
